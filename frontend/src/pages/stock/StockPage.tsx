            ...
            <div className="grid grid-cols-2 gap-2">
              <button type="button"
                onClick={() => {
                  ...
                  if (!isNaN(n) && n < 0) setQty(String(-n))
                  else if (isNaN(n) || n === 0) setQty('')
                }}
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1.5">
              ...
              <span className="ml-2 text-xs font-normal text-gray-400">
                {isEntry ? '(entrer une valeur positive)' : isExit ? '(entrer une valeur négative)' : 'Sélectionnez Entrée ou Sortie'}
              </span>
            </label>
